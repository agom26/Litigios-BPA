...
{
    public class CasoConstitucionalAmparoModel
    {
        private CasosConstitucionalesAmparoDataAccess casoConstitucionalData = new CasosConstitucionalesAmparoDataAccess();
