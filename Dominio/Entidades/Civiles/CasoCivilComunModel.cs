...
{
    public class CasoCivilComunModel
    {
        ComunCivilDataAccess casoCivilData = new ComunCivilDataAccess();
        ...
        public async Task<ApiResponseCrearCasoCivil> CrearCasoCivil(CrearCasoCivilRequest req)
        {
            try
            {
                ...
                if (!req.TercerosInteresados.Any())
                    return new ApiResponseCrearCasoCivil { success = false, message = "Debe ingresar al menos un tercero interesado" };
