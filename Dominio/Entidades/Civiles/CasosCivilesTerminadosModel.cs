...
{
    public class CasosCivilesTerminadosModel
    {
        CasosCivilesTerminadosDataAccess casoCivilModel = new CasosCivilesTerminadosDataAccess();
        public async Task<ApiResponseCasosCivilesList> ObtenerCasos(
            int usuarioId,
            int pagina,
            int registros,
            string? filtro = null
        )
        {
            try
            {
                ...
                return await casoCivilModel.ListarCasos(usuarioId, pagina, registros, filtro);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResponseCrearCasoCivil> CrearCasoCivil(CrearCasoCivilRequest req)
        {
            try
            {
                ...
                // Llamar DataAccess
                return await casoCivilModel.CrearCasoCivil(req);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResponseEditarCasoCivil> EditarCasoCivil(EditarCasoViaApremioRequest req)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(req.Origen))
                    return new ApiResponseEditarCasoCivil { success = false, message = "Origen de historial es requerido" };
                ...
                return await casoCivilModel.EditarCasoCivil(req);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResponse<object>> EliminarCasoCivil(int casoId, int usuarioId)
        {
            try
            {
                ...
                return await casoCivilModel.EliminarCasoCivil(casoId, usuarioId);
            }
            catch (Exception ex)
            {
