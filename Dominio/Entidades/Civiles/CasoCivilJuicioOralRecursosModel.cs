...
{
    public class CasoCivilJuicioOralRecursosModel
    {
        CasosCivilesRecursosDataAccess casoCivilData = new CasosCivilesRecursosDataAccess();
        ...
        )
        {
            try
            {
                ...
                return await casoCivilData.ListarCasosCiviles(usuarioId, pagina, registros, tipoRecurso, filtro);
            }
            catch (Exception ex)
            {
