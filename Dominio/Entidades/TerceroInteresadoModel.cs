...
{
    public class TerceroInteresadoModel
    {
        private TerceroInteresadoDataAccess terceroInteresadoData= new TerceroInteresadoDataAccess();

        public async Task<ApiGetUserListResponse<List<PersonaListDataResponse>>> ObtenerTerceroInteresado(int pagina, int cantidad)
        {
            try
            {
                return await terceroInteresadoData.GetTercerosInteresados(pagina, cantidad);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiGetUserListResponse<List<PersonaListDataResponse>>> ObtenerTercerosInteresadosFiltrados(int pagina, int cantidad, string filtro)
        {
            try
            {
                return await terceroInteresadoData.GetTercerosInteresadosFiltrados(pagina, cantidad, filtro);
            }
            catch (Exception ex)
            {
                return new ApiGetUserListResponse<List<PersonaListDataResponse>>
        ...
        )
        {
            ...
            return await terceroInteresadoData.CrearTerceroInteresado(
                nombre,
                direccion,
                correo,
                telefono,
        ...
        public async Task<ApiDemandadoDetalleResponse> ObtenerDetallesTerceroInteresadoPorId(int idPersona)
        {
            try
            {
                return await terceroInteresadoData.ObtenerDetallesTerceroInteresadoPorId(idPersona);
            }
            catch (Exception ex)
            {
        ...
        )
        {
            ...
            return await terceroInteresadoData.EditarTerceroInteresado(
                idPersona,
                nombre,
                direccion,
                correo,
        ...
        public async Task<ApiResponse<object>> EliminarTerceroInteresado(int idPersona)
        {
            if (idPersona <= 0)
                ...
                {
                    success = false,
                    message = "ID de tercero interesado inválido"
                };

            return await terceroInteresadoData.EliminarTerceroInteresado(idPersona);
        }
    }
}
