...
{
    public class CasosCivilesTerminadosDataAccess
    {
        private readonly string _apiUrl = "http://bpa.com.es/peticiones-litigios/civiles/terminados.php";

        private static readonly HttpClient _http = new HttpClient();

        public async Task<ApiResponseCasosCivilesList> ListarCasos(
           int usuarioId,
           int pagina,
           int registros,
           string? filtro = null
