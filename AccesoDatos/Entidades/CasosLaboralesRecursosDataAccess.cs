...
namespace AccesoDatos.Entidades
{
    ...
    {
        private readonly string _apiUrl = "https://bpa.com.es/peticiones-litigios/casos_laborales_recursos.php";
        ...
        public async Task<ApiResponse<List<SubirArchivoCasoLaboralData>>> SubirArchivos(int casoId, List<string> filePaths)
        {
            ...
            try
            {
                ...
                using var response = await PostFormAsync(_apiUrlArchivos, form);
                var json = await response.Content.ReadAsStringAsync();
