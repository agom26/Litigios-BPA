...
{
    public partial class FrmAgregarEstadoConstitucional : Form
    {
        public string? expedienteC { get; set; }
        public string? motivoC { get; set;}

        public FrmAgregarEstadoConstitucional()
        {
            InitializeComponent();
        ...
        private void VerificarSiEstadoTieneVencimientoAutomatico()
        {
            ...
            bool requiereVencimiento =
                ...
                estado == "Liquidación de Costas/multas" ||
        ...
        private void btnGuardarUsuario_Click(object sender, EventArgs e)
        {
            ...
            EstadoConstitucional.fechaEstado = fechaEstado;
            EstadoConstitucional.estado = comboboxEstado.Text;
            EstadoConstitucional.fechaVencimiento = fechaVencimiento;
            EstadoConstitucional.observaciones = formatoCorrecto;
            this.Close();
        }
    }
}
