...
{
    public partial class FrmAgregarEstadoContenciosoRC : Form
    {
        public string? expedienteA { get; set; }
        public string? motivoC { get; set;}

        public FrmAgregarEstadoContenciosoRC()
        {
            InitializeComponent();
        ...
        private void btnGuardarUsuario_Click(object sender, EventArgs e)
        {
            ...
            if (estadoSeleccionado == "Amparo")
            {
                // Validar expediente
                if (string.IsNullOrWhiteSpace(txtExpediente.Text))
                {
                    MessageBox.Show("Debe ingresar el expediente para amparo.",
                        "Validación",
                ...
                {
                    expedienteA = txtExpediente.Text.Trim();
                }
