...
{
    public partial class Contencioso_Tributario_PI : Form, IAsyncLoadable
    {
        ...
        CATributarioModel casoContenciosoModel = new CATributarioModel();
        ...
        public Contencioso_Tributario_PI()
        {
            InitializeComponent();
        }
        ...
        void HabilitarBotonesCaso()
        {
            ...
            txtExpedienteRecursoCasacion.Enabled = !isLectorContencioso;
        ...
        private async void Contencioso_Tributario_PI_Load(object sender, EventArgs e)
        {
            await VerificarTipoUsuario();
            if (!_yaCargo)
                await LoadAsync();
                ...
                if (confirm == DialogResult.Yes)
                {
                    ...
                    if (EstadoContencioso.estado != null && EstadoContencioso.fechaEstado != null)
                    {
                        var response = await historialModel.TerminarCasoContencioso(
                            ...
                            origen: "ADMINISTRATIVO TRIBUTARIO PRIMER INSTANCIA"
                        );
        ...
        private void Contencioso_Tributario_PI_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void Contencioso_Tributario_PI_ResizeEnd(object sender, EventArgs e)
        {
