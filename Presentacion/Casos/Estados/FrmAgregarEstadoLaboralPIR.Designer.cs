...
{
    partial class FrmAgregarEstadoLaboralPIR
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAgregarEstadoLaboralPIR));
            ...
            comboboxEstado.Items.AddRange(new object[] { "Recursos contra resoluciones no definitivas/Recurso de revocatoria", "Recursos contra resoluciones no definitivas/Recurso de Nulidad", "Recursos contra resoluciones no definitivas/Contestación de Recurso de Nulidad", "Recursos contra resoluciones no definitivas/Recurso de Apelación", "Recursos contra resoluciones que ponen fin a juicio/Recurso de Aclaración y Ampliación", "Recursos contra resoluciones que ponen fin a juicio/Recurso de Apelación" });
            ...
            MaximizeBox = false;
            Name = "FrmAgregarEstadoLaboralPIR";
            Text = "AGREGAR ESTADO";
