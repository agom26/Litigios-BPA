...
{
    partial class FrmAgregarEstadoCivilPEC
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAgregarEstadoCivilPEC));
            ...
            comboboxEstado.Items.AddRange(new object[] { "Demanda presentada", "Admisión de demanda y mandamiento de ejecución", "Oposición del demandado", "Oposición del demandado/Audiencia por Oposición", "Oposición del demandado/Excepciones", "Período de prueba", "Sentencia", "Recurso de aclaración y ampliación", "Incidente de Liquidación", "Incidente de Liquidación/Período de prueba", "Auto que aprueba liquidación", "Recurso de Apelación" });
