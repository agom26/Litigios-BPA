...
{
    partial class FrmAgregarEstadoCivilJSSI
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAgregarEstadoCivilJSSI));
            ...
            comboboxEstado.Items.AddRange(new object[] { "Recurso de Apelación presentado", "Ocurso de hecho", "Apertura a prueba", "Vista", "Resolución" });
            ...
            MaximizeBox = false;
            Name = "FrmAgregarEstadoCivilJSSI";
            Text = "AGREGAR ESTADO";
