...
{
    partial class FrmAgregarEstadoCivilJSPI
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAgregarEstadoCivilJSPI));
            ...
            comboboxEstado.Items.AddRange(new object[] { "Demanda presentada", "Excepciones previas", "Contestación de la demanda", "Apertura a prueba", "Vista", "Sentencia/Recurso de aclaración y ampliación", "Sentencia/Recurso de Apelación" });
            ...
            MaximizeBox = false;
            Name = "FrmAgregarEstadoCivilJSPI";
            Text = "AGREGAR ESTADO";
