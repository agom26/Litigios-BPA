...
{
    partial class FrmAgregarEstadoCivilJOPI
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAgregarEstadoCivilJOPI));
            ...
            comboboxEstado.Items.AddRange(new object[] { "Demanda presentada", "Juicio Verbal y Período Conciliatorio", "Excepción dilatoria", "Excepción perentoria", "Reconvención", "Audiencia para recepción de pruebas", "Audiencia de Incidentes", "Auto para mejor fallar", "Sentencia", "Recursos contra resoluciones no definitivas/Recurso de Nulidad", "Recursos contra resoluciones no definitivas/Contestación de Recurso de Nulidad", "Recursos contra resoluciones que ponen fin a juicio/Recurso de Aclaración y Ampliación", "Recursos contra resoluciones que ponen fin a juicio/Recurso de Apelación" });
            ...
            MaximizeBox = false;
            Name = "FrmAgregarEstadoCivilJOPI";
            Text = "AGREGAR ESTADO";
