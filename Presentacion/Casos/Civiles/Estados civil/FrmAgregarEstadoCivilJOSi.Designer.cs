...
{
    partial class FrmAgregarEstadoCivilJOSI
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAgregarEstadoCivilJOSI));
            ...
            comboboxEstado.Items.AddRange(new object[] { "Recurso de Apelación presentado", "Audiencia", "Vista", "Audiencia para recepción de pruebas", "Sentencia", "Recurso de aclaración y ampliación", "Recurso de Revocatoria y/o Reposición" });
            ...
            MaximizeBox = false;
            Name = "FrmAgregarEstadoCivilJOSI";
            Text = "AGREGAR ESTADO";
