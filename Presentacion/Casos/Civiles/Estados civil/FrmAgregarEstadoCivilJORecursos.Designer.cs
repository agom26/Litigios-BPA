...
{
    partial class FrmAgregarEstadoCivilJORecursos
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAgregarEstadoCivilJORecursos));
            ...
            comboboxEstado.Items.AddRange(new object[] { "Recursos contra resoluciones no definitivas/Recurso de Nulidad", "Recursos contra resoluciones no definitivas/Contestación de Recurso de Nulidad", "Recursos contra resoluciones que ponen fin a juicio/Recurso de Aclaración y Ampliación", "Recursos contra resoluciones que ponen fin a juicio/Recurso de Apelación" });
            ...
            // 
            // FrmAgregarEstadoCivilJORecursos
            // 
            ...
            MaximizeBox = false;
            Name = "FrmAgregarEstadoCivilJORecursos";
            Text = "AGREGAR ESTADO";
