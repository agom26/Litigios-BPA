...
{
    public partial class Civil_terminados : Form, IAsyncLoadable
    {
        ...
        CasosCivilesTerminadosModel casoCivilModel = new CasosCivilesTerminadosModel();
        ...
        private async Task CargarCasos()
        {
            ...
            var response = await casoCivilModel.ObtenerCasos(idUsuario, paginaActual, registrosPorPagina, filtro);
        ...
        private async void Civil_terminados_Load(object sender, EventArgs e)
        {
            if (!_yaCargo)
                await LoadAsync();
        ...
        private void Civil_terminados_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void btnAgregarEstado_Click(object sender, EventArgs e)
        {
            ...
            if(ultimoOrigenHistorial == "CIVIL JUICIO SUMARIO PRIMER INSTANCIA")
            {
                FrmAgregarEstadoCivilJSPI frmAgregarEstadoCivilPI = new FrmAgregarEstadoCivilJSPI();
                frmAgregarEstadoCivilPI.ShowDialog();

            }
            else if(ultimoOrigenHistorial == "CIVIL JUICIO SUMARIO SEGUNDA INSTANCIA")
            {
        ...
        private void Civil_terminados_ResizeEnd(object sender, EventArgs e)
        {
        ...
        private async void dtgHistorial_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var item = row.DataBoundItem as HistorialCasoCivilDetalle;
