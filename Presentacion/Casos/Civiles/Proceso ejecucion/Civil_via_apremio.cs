...
{
    public partial class Civil_via_apremio : Form, IAsyncLoadable
    {
        ...
        private BindingSource bsCasosCiviles = new BindingSource();
        ...
        CasoCivilViaApremioModel casoCivilModel = new CasoCivilViaApremioModel();
        ...
        public async Task LoadAsync()
        {
            ...
            dtgCasosCiviles.DataSource = bsCasosCiviles;
        ...
        private async Task CargarCasos()
        {
            ...
            if (response.success)
            {
                ...
                {
                    bsCasosCiviles.DataSource = response.data;
        ...
        private async void Civil_via_apremio_Load(object sender, EventArgs e)
        {
            await VerificarTipoUsuario();
            if (IsDisposed || !IsHandleCreated) return;
        ...
        private async Task GuardarCaso()
        {
            ...
            // Estado/Fecha: tu app depende de EstadoCivil
            ...
            if (string.IsNullOrWhiteSpace(comboBoxTitulo.Text))
            {
                MessageBox.Show("Título es requerido.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                comboBoxTitulo.Focus();
                return;
            }
                ...
                if (confirm == DialogResult.Yes)
                {
                    ...
                    if (EstadoCivil.estado != null && EstadoCivil.fechaEstado != null)
                    {
                        var response = await historialModel.TerminarCasoCivil(
                            ...
                            origen: "CIVIL PROCESO DE EJECUCIÓN VÍA APREMIO"
                        );
        ...
        private void Civil_via_apremio_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void Civil_via_apremio_ResizeEnd(object sender, EventArgs e)
        {
        ...
        {
            var res = await archivoModel.ListarArchivosCasoCivil(_idCasoEditar);
        ...
        private async void dtgArchivos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (colName == "Abrir")
                {
                    ...
                    await EjecutarConLoaderAsync(async () =>
                    {
                        resp = await archivoModel.DescargarArchivoCasoCivil(_idCasoEditar, archivoId, tempFile);
                    });
        ...
        private void VerificarEstadoEditarHistorial()
        {
            ...
            bool requiereVencimiento = EstadoCivilHelper.RequiereVencimiento(
                comboboxEstado.Text,
                origenActual
            );
