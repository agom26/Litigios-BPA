...
{
    public partial class Civil_segunda_instancia : Form, IAsyncLoadable
    {
        ...
        public Civil_segunda_instancia()
        {
            InitializeComponent();
        }
        ...
        private async void Civil_segunda_instancia_Load(object sender, EventArgs e)
        {
            await VerificarTipoUsuario();
            if (!_yaCargo)
                await LoadAsync();
        ...
        private void Civil_segunda_instancia_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void Civil_segunda_instancia_ResizeEnd(object sender, EventArgs e)
        {
