...
{
    public partial class Civil_comun : Form, IAsyncLoadable
    {
        ...
        CasoCivilComunModel casoCivilModel = new CasoCivilComunModel();
        ...
        private async void Civil_comun_Load(object sender, EventArgs e)
        {
            await VerificarTipoUsuario();
            if (IsDisposed || !IsHandleCreated) return;
                ...
                if (confirm == DialogResult.Yes)
                {
                    ...
                    if (EstadoCivil.estado != null && EstadoCivil.fechaEstado != null)
                    {
                        var response = await historialModel.TerminarCasoCivil(
                            ...
                            origen: "CIVIL PROCESO DE EJECUCIÓN COMÚN"
                        );
        ...
        private void Civil_comun_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void Civil_comun_ResizeEnd(object sender, EventArgs e)
        {
