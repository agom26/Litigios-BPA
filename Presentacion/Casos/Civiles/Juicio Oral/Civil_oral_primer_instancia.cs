...
{
    public partial class Civil_oral_primer_instancia : Form, IAsyncLoadable
    {
        ...
        CasoCivilJuicioOralPI casoCivilModel = new CasoCivilJuicioOralPI();
        ...
        public Civil_oral_primer_instancia()
        {
            InitializeComponent();
        }
        ...
        private async void Civil_oral_primer_instancia_Load(object sender, EventArgs e)
        {
            await VerificarTipoUsuario();
            if (IsDisposed || !IsHandleCreated) return;
        ...
        private void Civil_oral_primer_instancia_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void Civil_oral_primer_instancia_ResizeEnd(object sender, EventArgs e)
        {
