...
{
    public partial class Civil_oral_segunda_instancia : Form, IAsyncLoadable
    {
        ...
        CasoCivilJuicioOralSIModel casoCivilModel = new CasoCivilJuicioOralSIModel();
        ...
        public Civil_oral_segunda_instancia()
        {
            InitializeComponent();
        }
        ...
        private void Civil_oral_segunda_instancia_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void Civil_oral_segunda_instancia_ResizeEnd(object sender, EventArgs e)
        {
