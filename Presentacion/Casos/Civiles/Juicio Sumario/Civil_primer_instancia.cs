...
{
    public partial class Civil_primer_instancia : Form, IAsyncLoadable
    {
        ...
        CasoCivilJuicioSumarioPIModel casoCivilModel = new CasoCivilJuicioSumarioPIModel();
        ...
        private async void Civil_primer_instancia_Load(object sender, EventArgs e)
        {
            await VerificarTipoUsuario();
            if (IsDisposed || !IsHandleCreated) return;
        ...
        private void Civil_primer_instancia_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void btnAgregarEstado_Click(object sender, EventArgs e)
        {
            if (!isLectorCivil)
            {
                FrmAgregarEstadoCivilJSPI frmAgregarEstado = new FrmAgregarEstadoCivilJSPI();
                frmAgregarEstado.ShowDialog();
        ...
        private void Civil_primer_instancia_ResizeEnd(object sender, EventArgs e)
        {
