...
{
    public partial class FrmAgregarSocioResponsable : Form
    {
        ...
        public FrmAgregarSocioResponsable(BindingList<UserListDataResponse> listaDestino)
        {
            InitializeComponent();
        ...
        private async void FrmAgregarSocioResponsable_Load(object sender, EventArgs e)
        {
