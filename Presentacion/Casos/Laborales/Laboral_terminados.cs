...
{
    public partial class Laboral_terminados : Form, IAsyncLoadable
    {
        ...
        CasoLaboralTerminadoModel casoLaboralModel = new CasoLaboralTerminadoModel();
        ...
        private void Laboral_terminados_Resize_1(object sender, EventArgs e)
        {
            CentrarPanel();
        }
        ...
        private void Laboral_terminados_ResizeEnd(object sender, EventArgs e)
        {
